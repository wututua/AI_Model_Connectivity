...
export function ConfigTab() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <section className="glass rounded-[22px] p-5 space-y-3 anim-fade-in" style={{ animationDelay: '40ms' }}>
      ...
      <section className="glass rounded-[22px] p-5 space-y-3 anim-fade-in" style={{ animationDelay: '110ms' }}>
      ...
      <section className="glass rounded-[22px] p-5 space-y-3 anim-fade-in" style={{ animationDelay: '180ms' }}>
