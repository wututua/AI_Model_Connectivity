...
.status-pill, .provider-status, .model-status { border-radius: 999px; padding: 8px 13px; font-weight: 800; font-size: 12px; background: var(--card-strong); border: 1px solid var(--border); white-space: nowrap; }
